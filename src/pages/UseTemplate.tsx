...
export default function UseTemplate() {
  ...
  if (!cv) {
    return (
      <div className="min-h-screen bg-transparent flex items-center justify-center text-gray-900 dark:text-white">
        <div className="text-center">
          <h2 className="text-xl font-semibold text-gray-900 dark:text-white">Template not found</h2>
          <button
  ...
  return (
    <div className="min-h-screen bg-transparent py-12 text-gray-900 dark:text-white">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white dark:bg-[#0D0D12] rounded-lg shadow-sm border border-gray-200 dark:border-white/5 overflow-hidden">
          <div className="p-6">
            <h1 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">Use This CV Template</h1>
            ...
            <div className="bg-gray-50 dark:bg-white/[0.02] rounded-lg p-6 mb-6 border border-gray-200/50 dark:border-white/5">
              <h2 className="text-lg font-medium text-gray-900 dark:text-white mb-2">Template Preview</h2>
              <div className="prose dark:prose-invert max-w-none">
                <h3 className="text-gray-900 dark:text-white">{cv.personal_info.full_name || 'Template Resume'}</h3>
                <p className="text-gray-600 dark:text-white/60">{cv.personal_info.summary}</p>
                
                <div className="mt-4">
                  <h4 className="text-sm font-medium text-gray-700 dark:text-white/80">Template includes:</h4>
                  <ul className="mt-2 space-y-1 text-sm text-gray-600 dark:text-white/60">
